...
//		}
//		// ファイルサイズ
//		total_step = file_length/ AODV_Service.MAX_SEND_FILE_SIZE +1;	// ファイル分割数
//		file_name_b_length = file_name.getBytes().length;	// ファイル名(byte)の長さ
//		
//		buffer = addMessageTypeFile(AODV_Service.MAX_SEND_FILE_SIZE, dest_add, source_add,
//				file_name,total_step);
//		
//		file_next_no = 1;
//		destination_address = dest_add;
//		
//		life_time = new Date().getTime() + AODV_Service.ACTIVE_ROUTE_TIMEOUT * 2;
//	}
//
...
//			buffer = addMessageTypeFile(file_length % AODV_Service.MAX_SEND_FILE_SIZE,
...
//					(total_step == file_next_no) ? file_length % AODV_Service.MAX_SEND_FILE_SIZE
//							: AODV_Service.MAX_SEND_FILE_SIZE);
//		} catch (IOException e) {
